...
//in tutorial aber alte version: instance_create(x , y + offset_y, obj_Rope);
//offset_y is 0 (see above) but if we would change that it would increase
...
physics_joint_set_value( attach, phy_joint_damping_ratio
...
//!!! um die länge zu verändern müssen wir das repeat wahrscheinlich bearbeiten
	...
	next_rope= instance_create_layer(x,y+offset, "Instances", obj_rope) ;
